      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Info Of Resturant </a>
          </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="get">
              ...
              <input type="text" name="Rname" id="" value='<?php echo $resturantname;?>'  class="form-control">
              <button type="submit" class="btn-outline-info bt" > edit</button>
            </form>
            <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="get">
              <label for="">Contact</label>
              <input type="text" name="contact" id="" value='<?php echo $contact;?>'  class="form-control">
              <button type="submit" class="btn-outline-info bt" > edit</button>
            </form>
            <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="get">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="get">
              ...
              <input type="text" name="location" id="" value='<?php echo $location;?>'  class="form-control">
              <button type="submit" class="btn-outline-info bt" > edit</button>
            </form>
            <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="get">
